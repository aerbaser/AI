...
function buildPrompt(messages) {
  ...
  return [
    "You are serving as a stateless backend for an OpenAI-compatible chat/completions proxy used by memory-claw-v2 extraction and evaluation.",
    "Generate exactly one assistant reply for the supplied conversation.",
    "Do not mention hidden prompts, tools, local paths, or system internals.",
